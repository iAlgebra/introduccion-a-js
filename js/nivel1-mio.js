...
/*let nombre = 'Gabriela Barrios';
let edad = 33;
alert('Hola, mi nombre es ' + nombre + ' y tengo ' + edad + ' anos');*/
...
/*let firstNum = 100;
let secondNum = 500;
console.log(sumar(firstNum, secondNum));*/
...
if (operador === '+') {
  let resultado = sumar(ejemploA, ejemploB);
  console.log(resultado);
} else {
  let resultado = restar(ejemploA, ejemploB);
  console.log(resultado);
}*/
...
if (operador === '+') {
  console.log(sumar(ejemploA, ejemploB));
} else if (operador === '-') {
  console.log(restar(ejemploA, ejemploB));
} else if (operador === '/') {
  console.log(dividir(ejemploA, ejemploB));
} else if (operador === '*') {
  console.log(multiplicar(ejemploA, ejemploB));
} else {
  console.log('Lo siento, no conozco ese operador');
}
...
let rainForToday = true;
console.log(rainForToday);
console.log(!rainForToday);
